...
$t=$t.Replace('Color.FromArgb(70 + (int)(pulse * 75), 0, 245, 255)','licAiState == "SPEAKING" ? Color.FromArgb(80 + (int)(pulse * 120), 255, 30, 30) : licAiState == "LISTENING" ? Color.FromArgb(70 + (int)(pulse * 120), 0, 150, 255) : Color.FromArgb(70, 0, 125, 180)')
$t=$t.Replace('new System.Drawing.Drawing2D.LinearGradientBrush(core, Color.FromArgb(8, 105, 210), Color.FromArgb(1, 22, 74), 90f)','new System.Drawing.Drawing2D.LinearGradientBrush(core, licAiState == "SPEAKING" ? Color.FromArgb(210, 35, 35) : licAiState == "LISTENING" ? Color.FromArgb(8, 105, 230) : Color.FromArgb(5, 55, 105), licAiState == "SPEAKING" ? Color.FromArgb(75, 5, 5) : licAiState == "LISTENING" ? Color.FromArgb(1, 22, 90) : Color.FromArgb(1, 18, 48), 90f)')
