...
OutputBaseFilename=Setup_LEAL_INFO_PDV_V10_172_LIA_FINAL
...
; Instalação limpa do programa. Cadastros, licença e backups ficam em LocalAppData e são preservados.
[InstallDelete]
