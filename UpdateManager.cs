...
{
 public const string CurrentVersion="10.265";
 ...
 private static async Task<UpdateManifest?> LoadManifestAsync()
 {
  ...
  http.DefaultRequestHeaders.UserAgent.ParseAdd("LEAL-INFO-PDV-Updater/10.265");
